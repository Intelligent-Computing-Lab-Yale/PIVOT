...
from model_deits_quant import VisionTransformerDiffPruning
...
def get_args_parser():
    ...
    parser.add_argument('--sharing', default='0',
...
def main(args):
    ...
    if args.model == 'deit-s':
        ...
        # pretrained_shared = torch.load('./deit_small_patch16_224-cd65a155.pth', map_location='cpu')
    ...
    with torch.cuda.amp.autocast():
        with torch.no_grad():
            ...
            for i, (images, target) in enumerate(val_loader):
                ...
                end_time = time.time()
                execution_time = end_time - start_time
                # print("Loss time:", execution_time, "seconds")
